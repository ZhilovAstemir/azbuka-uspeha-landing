const items = [
  "🎒 Продлёнка", "📚 Подготовка к школе", "🔤 Английский", "♟ Шахматы", "⚡ Скорочтение",
  "💻 Программирование", "🛡️ Академия кибербезопасности", "✍️ Каллиграфия", "🎭 Театр и творчество", "🧠 Нейроупражнения", "📍 Нальчик, Атажукина 18",
];
